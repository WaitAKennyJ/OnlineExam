...
<div id="wrapper">
    ...
    <ul id="dropdown1" class="dropdown-content">
        <li><a><i class="fa fa-user fa-fw"></i> My Profile</a>
        </li>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a  class="active-menu waves-effect waves-dark"><i class="fa fa-desktop"></i> My Profile</a>
                </li>
                <li>
    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner">
            <form action="Action/update.action" class="col s12" method="post">
                <div class="row">
